...
/******/ 	__webpack_require__.p = "pj_demo/public/js";
/******/
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isLogin = __webpack_require__(7);
	var payment = __webpack_require__(8);
	var Fixtip = __webpack_require__(9);
	...
	function subAction(shopId, goodsCode, goodsName, payPrice, shopPrice) {
	    ...
	    doing = true;
	    $.post(ns + '/presale', { shopId: shopId, goodsCode: goodsCode, goodsName: goodsName, lat: appInfo.lat || '', lng: appInfo.lng || '', payPrice: payPrice, shopPrice: shopPrice }, function (_ref) {
	...
	function bindEvent() {
	    $('.sub-btn').on('tap', function () {
	        ...
	        var shopPrice = $this.data('shopprice');
	        var goodsName = $this.data('goodsname');
	        var $shops = $('input[name=shop_' + goodsCode + ']');
	        var shopId = '';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAppInfo = __webpack_require__(5);
